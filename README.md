...
Cada lente se aplica sobre un sistema real: una empresa, un producto, un equipo, un proceso, un espacio, un agente. Le das el material — documentación, reglas, o simplemente la descripción — y la lente devuelve un acta: qué ve, dónde duele y qué pregunta queda abierta.

Ninguna lente resuelve. Todas ordenan la mirada antes de decidir.
